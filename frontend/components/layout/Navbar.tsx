  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-6 md:px-[60px] py-4 bg-[rgb(var(--black-rgb)/0.8)] backdrop-blur-[24px] backdrop-saturate-[180%] border-b border-[var(--border)] shadow-[0_4px_24px_rgba(0,0,0,0.06)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.12)] transition-all duration-300">
      ...
      <div className="hidden md:flex gap-[10px] items-center relative z-[1]">
        ...
        <Link
          href="/auth/register"
          className="px-[26px] py-[10px] rounded-[10px] text-sm font-semibold text-white bg-gradient-to-br from-[#3b82f6] to-[#2563eb] border-none cursor-pointer transition-all duration-300 shadow-[0_4px_16px_rgba(59,130,246,0.4)] relative overflow-hidden hover:translate-y-[-3px] hover:shadow-[0_8px_28px_rgba(59,130,246,0.6)] before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-br before:from-[#60a5fa] before:to-[#3b82f6] before:opacity-0 before:transition-opacity before:duration-300 before:z-[-1] hover:before:opacity-100"
        >
          Get Started Free
        </Link>
      </div>
