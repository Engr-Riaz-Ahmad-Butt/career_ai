...
type LinkedInBioInput = Partial<CoverLetterInput>;
...
export const aiApi = {
    ...
    generateCoverLetter: (data: CoverLetterInput) => api.post('/ai/generate-cover-letter', data).then((res) => res.data),
    generateSOP: (data: CoverLetterInput) => api.post('/ai/generate-sop', data).then((res) => res.data),
    generateLinkedInBio: (data: LinkedInBioInput) => api.post('/ai/generate-linkedin-bio', data).then((res) => res.data),
    generateInterviewPrep: (data: GenerateInterviewPrepInput) => api.post('/ai/interview-prep', data).then((res) => res.data),
