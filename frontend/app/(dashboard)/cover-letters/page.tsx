...
function useCoverLetters() {
    return useQuery({
        queryKey: queryKeys.documents.byType('COVER_LETTER'),
        queryFn: () => documentApi.list({ type: 'COVER_LETTER' }),
    });
}
...
export default function CoverLettersPage() {
    ...
    return (
        <FeatureErrorBoundary featureName="Cover Letters">
