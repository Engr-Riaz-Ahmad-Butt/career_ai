    ...
    <>
      ...
      <div className="pt-20">
        ...
        <div className="px-[60px] py-20 max-w-[1100px] mx-auto relative">
          ...
          <h1 className="font-[var(--font-d)] text-[clamp(38px,5.5vw,66px)] font-extrabold leading-tight tracking-[-0.03em] text-white max-w-[760px] mb-5">
        ...
        <section className="px-[60px] py-[72px]">
          ...
          <div className="mt-8 px-8 py-7 bg-[rgba(59,130,246,0.05)] border border-[rgba(59,130,246,0.15)] rounded-[14px] flex items-center justify-between gap-4 flex-wrap max-w-[1100px] mx-auto">
            ...
            <button className="px-[22px] py-[10px] rounded-[9px] bg-gradient-to-br from-[#3b82f6] to-[#1d4ed8] text-white font-[var(--font-d)] font-bold text-[13px] border-none cursor-pointer whitespace-nowrap">
              See Open Roles →
            </button>
          </div>
        </section>
